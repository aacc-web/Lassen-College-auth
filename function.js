document.addEventListener("DOMContentLoaded", function() {
    ...
    loginForm.addEventListener("submit", function(event) {
        ...
        const emailInput = document.getElementById("frmLogin_UserName").value;
        const passwordInput = document.getElementById("frmLogin_Password").value;
    ...
    function validateEmail(email) {
        ...
        return mail.endsWith("@lassencollege.edu");
    }
